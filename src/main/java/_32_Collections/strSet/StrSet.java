...
//    수학에서의 집합 개념을 도입한게 set라고 생각하면됨.
//    특성 차이 때문에 list -> set, set -> list로 형변환하는게 중요
//    중복이 있는 list를 만들고 중복을 한번 제거하기 위해서 set로 변환후에 중복제거를 할  수 있다.
//* */
//
//import java.util.*;
//
...
//        strSet1.add("3");
//
//        System.out.println(strSet1); // 순서 x
//
//        // 출력
...
////            System.out.println(strSet1.get()); // 인덱스를 통해서 접근 x 일반 for문 불가
////        }
//
//        // 인덱스가 없어서 순서도 없기 때문에 접근 불가
//
//        // 특정 element추출 -> list로 형변환
//        strSet1.addAll(strSet1); //Collection으로 이루어진 것들이어야 들어감 - 요소 전체 추가
