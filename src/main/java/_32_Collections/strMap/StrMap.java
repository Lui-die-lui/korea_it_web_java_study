...
public class StrMap {
    ...
    public static void main(String[] args) {
        ...
        strMap1.put("kor2025001", "김준일"); // 키는 중복 안됨. 값 중복 가능
        ...
        //Why? 순회하기 위해서는 Iterable<?> 인터페이스를 구현한 클래스이거나 배열(T[]) 만 가능함
        ...
        // Map.Entry는 Map에 들어가는 데이터의 형식인 키 값 형태 인 것임.
        ...
        System.out.println("kor2025003의 존재 여부 : " + isContain);
        ...
        entryList1.addAll(entrySet2); // strMap1 = 타입이 달라서 x
